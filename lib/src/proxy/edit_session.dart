...
class _EditSessionProxy extends _HasProxy implements EditSession {
  ...
  final _onSelectionChange = new StreamController<int>.broadcast();
  Stream<int> get onSelectionChange => _onSelectionChange.stream;
  ...
  _EditSessionProxy._(js.JsObject proxy) : super(proxy) {
    ...
    call('on', ['selectionChange',
                (e,__) => _onSelectionChange.add(e.toInt())]);
